...
c. (1pt)  Use your function to find $P(Y\leq 5)$ for $a=2$ and $b=6$.
...
f. (2pts)  Find $\hat P(Y\leq 5)$; the *empirical* (i.e., observed) proportion of your simulated data that is $\leq 5$.  Is it similar to your answer from c?
