...
d. (2pts) Based on your plot from b, what appears to be the median of $Y$?  Find the exact value of the median by modifying your CDF function and using `uniroot()`.
