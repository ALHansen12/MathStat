...
c. (1pt)  Use your function to find $P(Y\leq 4)$.
d. (2pts) For $a=2$ and $b=6$, find the median of $Y$ analytically, then verify using `uniroot()`.
...
f. (2pts)  Find $\hat P(Y\leq 4)$; the *empirical* (i.e., observed) proportion of your simulated data that is $\leq 4$.  Is it similar to your answer from c?
